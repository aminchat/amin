...
function carousel() {
  const slides = [
    ...
    { art: 'balance', h: 'هدف در برابر واقعی', p: 'هر پاکت یک خط هدف دارد. سبز یعنی روی خط، زرد احتیاط، قرمز توقف. با زیرشاخه‌ها می‌بینی داخل هر پاکت پول دقیقاً به کجا می‌رود.' },
